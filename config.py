...
JUNIOR_POSITION_SCORE_THRESHOLD = int(80)  # Minimum Conviction Score to pass to Senior
JUNIOR_SWING_SCORE_THRESHOLD = int(80)     # Minimum Conviction Score to pass to Senior
