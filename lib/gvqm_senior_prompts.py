...
{{
  ...
  "winner": "TICKER",
  "rationale": "A concise, 6-sentence educational explanation of exactly why the winner was chosen. Explicitly connect the winning traits to the user's Safety/Reward mandate, ensuring the user learns the strategy behind your decision."
}}
"""