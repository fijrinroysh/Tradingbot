...
def send_executive_brief(decision, account_info, portfolio):
    """
    Sends the "Dual-Strategy" Executive Briefing v9.0.
    Now includes a 'Deep Dive' section for detailed analysis.
    """
    ...
    # ==========================================================
    # 🧠 SECTION 2: ANALYST DEEP DIVE (NEW!)
    # ==========================================================
    html_content += """
    ...
    html_content += f"""
        ...
        <p style="font-size: 10px; color: #999; text-align: center; margin-top: 20px;">
            GVQM Protocol v9.0 (Deep Dive) | {datetime.datetime.now().strftime("%H:%M EST")}
        </p>
        </div>
    </body>
    """
