...
* **BARGAIN:** The stock is trading at a historical discount. The downside is mathematically capped because the assets/cash flow support the price floor.
* **FAIR:** The stock is trading near its intrinsic value. It is reasonably priced, but offers no significant "Margin of Safety." The reward equals the risk.
...
* **THE BIAS TRAP (CRITICAL):** Do not confuse **Velocity** (Speed) with **Magnitude** (Size).
    * We are Value Investors, not Day Traders.
    * A stock that is 50% undervalued but takes a year to recover is **HUGE**.
    * A stock that pops 5% tomorrow is **LOW**.
    * **Focus strictly on the SIZE of the prize.**
...
{{
  ...
  "catalyst": "What event will force the market to see the value?",
